...
InputDiff::InputDiff(long timeDiff, Gamecube_Data_t *firstData, Gamecube_Data_t *secondData) {
    this->timeDiff = timeDiff;
    this->inputDiffs = this->createDiffs(firstData, secondData);
}

LinkedList<SingleInputDiff>* InputDiff::createDiffs(Gamecube_Data_t *firstData, Gamecube_Data_t *secondData) {
    LinkedList<SingleInputDiff>* inputDiffsList = new LinkedList<SingleInputDiff>();
